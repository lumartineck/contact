...
import com.freedompop.contact.repository.RoleRepository;
import com.freedompop.contact.repository.UserRepository;
...
public class UserServiceTest {
	...
	public void setUp() {
		...
		user = User.builder().id(1).name("Enrique").lastName("Martinez").email("enrique@martinez.com").build();
	...
	public void testFindUserByEmail() {
		// Setup
		final String email = "enrique@martinez.com";
